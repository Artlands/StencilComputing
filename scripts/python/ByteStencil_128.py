...
posi1 = [1.8, 3.8, 5.8, 7.8 ,9.8 ,11.8]
posi2 = [2.2, 4.2, 6.2, 8.2 ,10.2 ,12.2]
#Stencil size
size_grid_64 = 262144
...
ax.vlines(posi1, ymin=0, ymax=host_point_128, color='#7badce', alpha=1, linewidth=18)
ax.plot(posi1, host_point_128,"o", markersize=18, color='#007ACC', alpha=1, label = "Without PIMS")

ax.vlines(posi2, ymin=0, ymax=pims_point_128, color='#edbc92', alpha=1, linewidth=18)
ax.plot(posi2 , pims_point_128,"o", markersize=18, color='#f18e3a', alpha=1, label = "With PIMS")
...
plt.ylabel('Bytes Per Stencil (Bytes)', fontsize = 16)
...
plt.tight_layout()
plt.savefig('ByteStencil_128.eps', format='eps', dpi=1000)
# plt.show()

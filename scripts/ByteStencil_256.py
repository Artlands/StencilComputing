...
ax.vlines(posi1, ymin=0, ymax=host_point_256, color='#7badce', alpha=1, linewidth=18)
ax.plot(posi1, host_point_256,"o", markersize=18, color='#007ACC', alpha=1, label = "Without PIMS")

ax.vlines(posi2, ymin=0, ymax=pims_point_256, color='#edbc92', alpha=1, linewidth=18)
ax.plot(posi2 , pims_point_256,"o", markersize=18, color='#f18e3a', alpha=1, label = "With PIMS")
...
plt.tight_layout()
plt.savefig('ByteStencil_256.eps', format='eps', dpi=1000)
# plt.show()

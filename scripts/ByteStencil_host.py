...
ax.vlines(posi1, ymin=0, ymax=host_point_64, color='#7badce', alpha=1, linewidth=18)
ax.plot(posi1, host_point_64,"o", markersize=18, color='#007ACC', alpha=1, label = "Grid 64x64x64")

ax.vlines(orders, ymin=0, ymax=host_point_128, color='#edbc92', alpha=1, linewidth=18)
ax.plot(orders , host_point_128,"o", markersize=18, color='#f18e3a', alpha=1, label = "Grid 128x128x128")

ax.vlines(posi2, ymin=0, ymax=host_point_256, color='#8bae91', alpha=1, linewidth=18)
ax.plot(posi2, host_point_256,"o", markersize=18, color='#55885e', alpha=1, label = "Grid 256x256x256")
